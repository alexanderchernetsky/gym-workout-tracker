...
export const workouts: Workout[] = [
    ...
    },
    {
        ...
        exercises: [exercises[5], exercises[6], exercises[7], exercises[8], exercises[9], exercises[10], exercises[11]]
    },
    {
        id: 3,
        name: 'Three day split. Workout C',
        muscleTypes: 'chest, middle delt, triceps',
        exercises: [exercises[12], exercises[13], exercises[14], exercises[15], exercises[16], exercises[17], exercises[18]]
    }
];
