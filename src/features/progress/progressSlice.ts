...
export const deleteProgressItem = createAsyncThunk(
    ProgressPageActions.DELETE_PROGRESS_ITEM,
    async (id: number) => {
...
export const progressSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(getProgressItems.fulfilled, (state: IProgressFeatureState, action) => {
            return {
